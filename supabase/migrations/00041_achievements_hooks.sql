-- Wire check_achievements into place_tag_scored, create_crew, and join_crew

-- ============================================================
-- Update place_tag_scored to check achievements after XP update
-- ============================================================
...
begin
  ...
  v_newly_unlocked := check_achievements(v_auth_uid);
...
-- ============================================================
-- Update create_crew to check achievements after crew creation
-- ============================================================
...
begin
  ...
  -- Check achievements (Crew Up, Crew Leader)
  v_newly_unlocked := check_achievements(v_uid);

  return jsonb_build_object('success', true, 'crew_id', v_crew_id, 'newly_unlocked', v_newly_unlocked);
end;
$$;

-- ============================================================
-- Update join_crew to check achievements after joining
-- ============================================================
...
begin
  ...
  -- Check achievements (Crew Up)
  v_newly_unlocked := check_achievements(v_uid);

  return jsonb_build_object('success', true, 'crew_id', v_invite.crew_id, 'newly_unlocked', v_newly_unlocked);
end;
$$;
